...
# 设置文件路径
bam_files=(
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Rice/Os-L0h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Rice/Os-L168h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Rice/Os-L24h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Rice/Os-L2h.bam"
)
gff_file="/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/reference/Rice/Oryza_sativa.IRGSP-1.0.59.chr.gff3"

# 创建输出目录
output_dir="/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Rice/cufflinks_output"
mkdir -p $output_dir
