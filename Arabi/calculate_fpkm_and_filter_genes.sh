...
# 设置文件路径
bam_files=(
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/At-L0h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/At-L168h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/At-L24h.bam"
    "/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/At-L2h.bam"
)
gff_file="/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/Arabidopsis_thaliana.TAIR10.59.gff3"

# 创建输出目录
output_dir="/Data4/gly_wkdir/coldgenepredict/raw_sec/Arabidopsis/Arabi/cufflinks_output"
mkdir -p $output_dir
